...
function init() {
    ...
    // Room.glb стиснутий через Draco (геометрія) + Meshopt (додаткова оптимізація),
    // щоб файл влазив у ліміти git (~83МБ замість ~123МБ). Без цих декодерів
    // такий файл просто не розпакується і завантаження впаде з помилкою.
    ...
    if (typeof MeshoptDecoder !== 'undefined') {
        ...
        console.warn('MeshoptDecoder не завантажився — якщо Room.glb стиснутий через Meshopt, завантаження може не спрацювати.');
    }
